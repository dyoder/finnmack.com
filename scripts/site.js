...
var addTwitterUpdates = function() {
	if ($('#twitter').length > 0) {
		$('head').append("<script type='text/javascript' src='http://api.twitter.com/1/statuses/user_timeline.json?screen_name=finnmack&count=3&callback=showTweets'></script>");
	}
};
